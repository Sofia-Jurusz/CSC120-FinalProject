...
public class WiseLady extends Person{
    ...
    public void conversation(Player player){
        if (this.talkToCount==0){
            ...
            if (player.getInventory().contains(requirements.get(0)) && player.getInventory().contains(requirements.get(1))) { 
                System.out.println();
                ...
                System.out.println("Your may need this sword, and I will give you one krabby patty for the road.");
                ...
                String[] newDirections = new String[]{"south","east"};
